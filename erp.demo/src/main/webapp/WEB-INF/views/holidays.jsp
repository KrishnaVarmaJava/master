...
<div class="wrapper">
            ...
            <div class="container-fluid">
			 ...
			 <div class="row clearfix">
				...
				<span > Holidays </span>
	             ...
	             <div class="col-md-6">
				 <div class="row pagetitle">
				<span class="pull-right" > 	 <button type="button" id="addnew"  class="btn btn-primary btn-rounded waves-effect">Add New Holiday</button> </span>
				 </div>
				  </div>
  ...
  <span aria-hidden="true">&times;</span>
                                                                ...
                                                                <div class="input-group addon-line">
                                                                    <div class="form-line">
																	   <label>Holiday Date</label>
                                                                        <input type="email" class="form-control" placeholder="Holiday Date">
                                                                    </div>
					 ...
					 <button type="button" class="btn btn-primary btn-rounded waves-effect">Create Holiday</button>
					 </div>
					</div>
                            ...
                            <div class="body">
                                <table class="tablesaw table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th data-tablesaw-sortable-col data-tablesaw-priority="3">Title </th>
                                        <th data-tablesaw-sortable-col data-tablesaw-priority="2">Holiday Date</th>
                                        <th data-tablesaw-sortable-col data-tablesaw-priority="4">Day </th>
