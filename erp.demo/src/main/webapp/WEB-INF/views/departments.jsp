            ...
            <div class="container-fluid">
			 ...
			 <div class="row clearfix">
				...
				<span > Department</span>
	             ...
	             <div class="col-md-6">
				 <div class="row pagetitle">
				<span class="pull-right" > 	 <button type="button" class="btn btn-primary btn-rounded waves-effect">Add New Department </button> </span>
				 </div>
				  </div>
				...
				<hr class="custom_line">	
					 ...
					 <button type="button" class="btn btn-primary btn-rounded waves-effect">Create Department</button>
					 </div>
					</div>
                            ...
                            <div class="body">
                                <table class="tablesaw table-striped table-bordered table-hover">
                                    ...
                                    <tr>
                                        ...
                                        <th data-tablesaw-sortable-col data-tablesaw-priority="3">Department Name </th>
